...
#define ALG_IRCUT_AUTO      0
#define ALG_IRCUT_OPEN      1
#define ALG_IRCUT_CLOSE     2

#define ALG_FPS_NONE        0
#define ALG_FPS_LOW         1
#define ALG_FPS_5FPS        2
